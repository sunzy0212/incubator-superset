          ...
          (
            <div className="scrollbar-container">
              ...
              >
                <QueryTable
                  columns={[
                    {key:'state', label:"状态"},  {key:'db', label:"数据库"}, {key:'user', label:"用户"}, {key:'time', label:"时间"},
                    {key:'progress', label:"进度"}, {key:'rows', label:"返回结果条数"}, {key:'sql', label:"查询语句"}, {key:'querylink', label:"打开链接"},
                  ]}
